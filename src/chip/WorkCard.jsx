        ...
        return (
          ...
          >
            <POPUP className="img-content relative">
              <div className="h-[300px] w-[480px] hover:scale-125 transition duration-500 cursor-pointer shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] sm:bg-cover mx-auto ">
                <img
                  src={data.img}
                  alt={data.title}
              ...
              <div
                className={` popup w-full  h-[300px] shadow-xl rounded-md overflow-hidden sm:h-[260px] sm:w-[92%] p-4`}
              >
