...
const Work = () => {
  return (
    <div id="works" className="container m-auto mt-16">
      ...
      {/* card */}
      <div className="card-wrapper mx-auto w-[100%] sm:w-fit mt-4">
        <div className="grid grid-cols-2 space-x-5 w-full md:grid-cols-1 sm:gap-8 sm:grid-cols-1  sm:space-y-0 sm:space-x-0 ">
          <WorkCard />
        </div>
      </div>
    </div>
